...
struct = ['股票名字','今日开盘价','昨日收盘价','当前价格','今日最高价','今日最低价','竞买价','竞卖价','成交的股票数','成交金额','买一','买一报价','买二','买二报价',\
            '买三','买三报价','买四','买四报价','买五','买五报价','卖一','卖一报价','卖二','卖二报价','卖三','卖三报价','卖四','卖四报价','卖五','卖五报价','日期','时间','unknow']


rowitems = ['股票名字','涨跌幅','今日开盘价','昨日收盘价','当前价格','今日最高价','今日最低价','卖一','卖一报价']
...
class SimpleModel:
    ...
    def ParseData(self,var):
        ...
        data['涨跌幅'] = (data['当前价格']-data['昨日收盘价'])/data['昨日收盘价']
